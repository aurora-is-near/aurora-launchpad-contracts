...
use crate::{IntentsAccount, date_time};
...
pub struct DiscountParams {
    ...
    pub public_sale_start_time: u64,
}
...
impl DiscountPhase {
    #[must_use]
    pub fn check_sale_limits_exceeded(
        &self,
        sale_tokens_per_account: u128,
        sale_tokens_per_phase: u128,
    ) -> (u128, u128) {
        (
            self.phase_sale_limit
                .map_or(0, |limit| sale_tokens_per_phase.saturating_sub(limit.0)),
