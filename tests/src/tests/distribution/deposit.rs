...
async fn test_reentrancy_protection() {
    ...
    // Alice's attempt to execute multiple distributes in one block and exploit reentrancy vulnerability.
    ...
    result2.assert_error("Deposit distribution is ongoing");
